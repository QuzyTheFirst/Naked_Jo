...
public class BigKatanaManAttackState : BigKatanaManBaseState
{
    private Vector2 _attackPos;

    private bool _aimAtPlayer;

    public BigKatanaManAttackState(BigKatanaMan context, BigKatanaManStateFactory factory) : base(context, factory) { }
