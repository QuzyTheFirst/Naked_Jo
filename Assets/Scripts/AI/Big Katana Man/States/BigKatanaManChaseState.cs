...
public class BigKatanaManChaseState : BigKatanaManBaseState
{
    public BigKatanaManChaseState(BigKatanaMan context, BigKatanaManStateFactory factory) : base(context, factory) { }
    ...
    private void KeepGoingOrStop(BigKatanaMan context)
    {
    ...
    private bool WallCheck(BigKatanaMan context, float movementDir)
    {
        //Wall
    ...
    private static bool FloorCheck(BigKatanaMan context, float movementDir)
    {
        //Floor
