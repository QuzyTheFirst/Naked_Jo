...
public class BigKatanaManRollingState : BigKatanaManBaseState
{
    public BigKatanaManRollingState(BigKatanaMan context, BigKatanaManStateFactory factory) : base(context, factory) { }
    ...
    private bool ObstaclesCheck(BigKatanaMan context)
    {
