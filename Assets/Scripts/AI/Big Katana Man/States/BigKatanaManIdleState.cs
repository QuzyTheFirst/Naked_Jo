...
public class BigKatanaManIdleState : BigKatanaManBaseState
{
    public BigKatanaManIdleState(BigKatanaMan context, BigKatanaManStateFactory factory) : base(context, factory) { }
    ...
    private void SetWeaponTargetPos(BigKatanaMan context)
    {
