...
public class SturdyJumpingState : SturdyBaseState
{
    private float _jumpPower;

    public SturdyJumpingState(Sturdy context, SturdyStateFactory factory) : base(context, factory)
    {
        IsRootState = true;
    }
    ...
    // Methods
    private void JumpAction(Sturdy context)
    {
